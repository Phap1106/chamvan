...
export default function ShareButton({ path, title }: Props) {
  ...
  // Sao chép có fallback cho môi trường không hỗ trợ clipboard API
  async function doCopy() {
    const text = url;
    try {
      ...
      // Không dùng toast nữa để tránh lỗi UI, chỉ log lỗi
    }
  }
  ...
  return (
    <>
      ...
      <button
        type="button"
        onClick={() => setOpen(true)}
        className="inline-flex items-center gap-1.5 rounded-full border border-neutral-200 px-3 py-1.5 text-sm font-medium text-neutral-800 transition hover:bg-neutral-50 active:scale-[0.98]"
      >
            ...
            <div className="px-5 pt-4 pb-5">
              ...
              <div className="flex">
                <input
                  readOnly
                  value={url}
                  className="flex-1 rounded-l-lg border border-neutral-300 px-3 py-2 text-xs sm:text-sm outline-none focus:ring-2 focus:ring-neutral-900"
                />
                <button
                  type="button"
                  onClick={doCopy}
                  className="inline-flex items-center gap-1.5 rounded-r-lg border border-l-0 border-neutral-300 bg-neutral-50 px-3 py-2 text-xs sm:text-sm hover:bg-neutral-100"
                >
                  {copied ? (
                    <>
              ...
              <div className="mt-5 grid grid-cols-2 gap-3 text-sm sm:grid-cols-5">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group inline-flex items-center justify-center gap-2 rounded-lg bg-[#1877F2] px-3 py-2 text-xs sm:text-sm text-white shadow hover:brightness-110"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group inline-flex items-center justify-center gap-2 rounded-lg bg-[#00B2FF] px-3 py-2 text-xs sm:text-sm text-white shadow hover:brightness-110"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group inline-flex items-center justify-center gap-2 rounded-lg bg-[#0068FF] px-3 py-2 text-xs sm:text-sm text-white shadow hover:brightness-110"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group inline-flex items-center justify-center gap-2 rounded-lg bg-black px-3 py-2 text-xs sm:text-sm text-white shadow hover:brightness-110"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group inline-flex items-center justify-center gap-2 rounded-lg bg-[#229ED9] px-3 py-2 text-xs sm:text-sm text-white shadow hover:brightness-110"
                >
              ...
              <button
                type="button"
                onClick={nativeShare}
                className="mt-4 text-xs text-neutral-600 underline underline-offset-2 hover:text-neutral-900 sm:text-sm"
              >
                Chia sẻ bằng hệ thống (nếu hỗ trợ)
              </button>
            </div>
