...
// import pick1 from '@/app/img/topics/topic1.jpg';
// import pick2 from '@/app/img/topics/topic2.jpg';
// import pick3 from '@/app/img/topics/topic3.jpg';
// import pick4 from '@/app/img/topics/topic4.jpg';
// import pick5 from '@/app/img/topics/topic5.jpg';
// import pick6 from '@/app/img/topics/topic6.jpg';
// import pick7 from '@/app/img/topics/topic7.jpg';
// import pick8 from '@/app/img/topics/topic8.jpg';
// import pick9 from '@/app/img/topics/topic9.jpg';
// import pick10 from '@/app/img/topics/topic10.jpg';
// import pick11 from '@/app/img/topics/topic11.jpg';
...
//       <h2 className="mb-10 text-3xl font-semibold tracking-wide text-center">TOP PICKS</h2>
...
//               >
//                 <div className="absolute text-2xl font-semibold tracking-wider text-white left-8 top-8">
//                   {it.title}
//                 </div>
//               </div>
//             );
...
const TILE_BG = '#8b2a2a';

export default function TopPicks() {
  const srcOf = (img: any) => (typeof img === 'string' ? img : img?.src);

  const items: PickItem[] = [
    { type: 'image', title: 'CASTLE',  src: srcOf(pick1) },
    { type: 'image',                   src: srcOf(pick2) },
    { type: 'image',                   src: srcOf(pick3) },
    { type: 'image',                   src: srcOf(pick4) },
    { type: 'image', title: 'TERRACE', src: srcOf(pick5) },
    { type: 'image',                   src: srcOf(pick10) },
    { type: 'image',                   src: srcOf(pick11) },
    { type: 'image', title: 'TERRACE', src: srcOf(pick8) },
    { type: 'image',                   src: srcOf(pick9) },
  ];
  ...
  return (
    <section
      className="
        mx-auto
        /* Giữ 3 cột nhưng thu hẹp container ở desktop để mỗi tile ≤ ~400px */
        max-w-[1000px] sm:max-w-[1100px] lg:max-w-[1200px] xl:max-w-[1200px] 2xl:max-w-[1240px]
        px-8 py-16
      "
    >
      <h2 className="mb-10 text-3xl font-semibold tracking-wide text-center">TOP PICKS</h2>
          ...
          return (
            ...
            >
              <Image
                ...
                alt={it.title ?? ''}
                fill
                /** Với container 1200px và 3 cột:
                 *  Ô ≈ (1200 - 2*24)/3 = ~384px ⇒ an toàn cho ảnh gốc ~800px ở DPR=2.
                 *  Khai báo sizes cố định theo px để Next xuất đúng biến thể 1x/2x.
                 */
                sizes="
