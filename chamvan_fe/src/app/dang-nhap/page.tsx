...
import { useState } from 'react';
import { useAuth } from '@/components/providers/AuthProvider';
import { Loader2, Mail, KeyRound, Eye, EyeOff, AlertCircle, HelpCircle } from 'lucide-react';
    ...
    <main className="px-4">
      <section className="mx-auto min-h-[72vh] max-w-6xl py-10 md:py-16">
        <div className="mx-auto w-full max-w-[420px]">
          ...
          <p className="mx-auto mt-6 max-w-[360px] text-center text-[11px] text-zinc-500">
            Khi đăng nhập, bạn đồng ý với{' '}
            <a href="/dieu-khoan-su-dung" className="underline">Điều khoản dịch vụ</a> và{' '}
            <a href="/bao-ve-du-lieu-ca-nhan" className="underline">Chính sách bảo mật</a>.
          </p>
        </div>
      </section>
    </main>
