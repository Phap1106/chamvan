...
function OrdersPageInner() {
  ...
  async function load() {
    ...
    setErr(null);
    try {
      // Trả về có thể là mảng hoặc dạng { items, total }
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 sm:px-5">
              <div className="text-[16px] sm:text-[18px] font-bold text-gray-900">
                ...
                <span className="tracking-wider">
                  #{open.code || String(open.id).padStart(10, '0')}
                </span>
              </div>
              <button
            ...
            <div className="grid grid-cols-1 divide-y divide-gray-200 md:grid-cols-3 md:divide-y-0 md:divide-x">
              ...
              <section className="p-4 sm:p-5">
                ...
                <div className="space-y-1 text-[14px] text-gray-800">
                  <div>
                    <span className="text-gray-600">Địa chỉ:</span> {open.shippingAddress || '—'}
                  </div>
                  {open.notes && (
                  ...
                  <div>
                    ...
                    {open.eta ? formatDate(open.eta, true) : '—'}
                  </div>
                  <div className="text-[13px] text-gray-600">
...
export default function OrdersPage() {
  return (
    <Suspense
      fallback={
        <AccountLayout title="Đơn đặt hàng của tôi">
          <div className="p-4 text-sm text-gray-600">Đang tải đơn hàng của bạn…</div>
        </AccountLayout>
      }
    >
      <OrdersPageInner />
